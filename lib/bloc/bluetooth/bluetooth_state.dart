...
class Esp32DeviceDisconnectedState extends BluetoothMainStateSettingUp {
  @override
  List<Object> get props => [];
}

/********************* Looking for Esp32 object and connecting... ***************************/

class SearchingForEsp32DeviceState extends BluetoothMainStateSettingUp{

  SearchingForEsp32DeviceState();
...
class Esp32DeviceFoundState extends BluetoothMainStateSettingUp{

  Esp32DeviceFoundState();
...
class Esp32DeviceNotFoundState extends BluetoothMainStateSettingUp{

  Esp32DeviceNotFoundState();
